...
public class SettingsFragment extends Fragment implements View.OnClickListener {
    ...
    public  void m107lambda$onViewCreated$8$comlockfragmentSettingsFragment(View view) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(SplashLaunchActivity.MoreApps));
...
//                startActivity(intentPrivacy);
            ...
            case R.id.rl_appsList:
                Intent intent2 = new Intent(getActivity(), AppsListActivity.class);
                SplashLaunchActivity.InterstitialAdsCall(getActivity(), intent2);
                return;
            default:
                return;
        }
